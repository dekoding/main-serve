/// File store entity reference query builders.
///
/// Handles INSERT, DELETE, and SELECT operations on the file-store-entity
...
///
/// Used to determine the next attachment order when adding file store references.
pub fn build_file_store_ref_max_order(
    table_name: &str,
    order_col: &str,
...
pub fn build_file_store_ref_insert(
    table_name: &str,
    columns: &[&str],
    driver: DatabaseDriver,
) -> BuiltQuery {
...
pub fn build_file_store_ref_select(
    table_name: &str,
    file_id_col: &str,
    entity_id_col: &str,
...
/// Used for detaching file store entries from content entities.
pub fn build_file_store_ref_delete(
    table_name: &str,
    file_id_col: &str,
    entity_id_col: &str,
    content_type_col: &str,
