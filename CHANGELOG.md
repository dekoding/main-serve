...
- Filtering for JSONB columns using dot-notation and LHS brackets
- Sorting for JSONB columns using dot-notation and LHS brackets
- Binary PKGBUILD for Arch Linux

[0.1.1]: https://github.com/dekoding/main-serve/releases/tag/v0.1.1
